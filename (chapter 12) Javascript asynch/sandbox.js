...
//Сетево запрос fetch - возвращает ПРОМИС который имеет 2 состояния и сам определяет выполнен запрос или нет, 
...
const gettodos = async () => {
    ...
    const response = await fetch('luigis.json');  //fetch по дефолту делате GET запрос 
